...
export default class EditExercise extends Component{
    ...
    componentDidMount(){
        ...
        .then( res =>{
               ...
               //  }
                 console.log( res.data.description, "Response from edit exercise")
        ...
        .catch(err => console.log(err));
        console.log( this.state.description, "user edit page did")
    }
    ...
    render(){
        console.log( this.state.description, "user edit page")
        return(
            <div>
                ...
                <form onSubmit={ this.onSubmit }>
                    ...
                    <div className="form-group">
                        <label>Duaration (in minutes): </label>
                        <input type="text"
                        required
                        className="form-control"
